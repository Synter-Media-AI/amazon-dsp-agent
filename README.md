...
Manage Amazon DSP programmatic campaigns with AI agents via MCP.

 `amazon-dsp` `programmatic-advertising` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage Amazon DSP — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> List DSP orders and line items

> Create a display campaign targeting in-market audiences

> Pull reach and frequency metrics

> Adjust line item bids based on ROAS
...
2. Click "Connect" next to Amazon DSP
